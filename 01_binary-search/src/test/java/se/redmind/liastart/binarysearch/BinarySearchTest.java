...
//            return new First().chop(key, values); // uncomment to test
//            return new Second().chop(key, values); // uncomment to test
            return new Third().chop(key, values); // uncomment to test
        }
    };
